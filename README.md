...
22.1 Как безопасно остановить один паток - Через флаг isinterupted и команду interupt;

22.2 Отличия isInterupted() и команду interupt -
...
10.1 При привышении Capacity на сколько увеличивается размер ArrayList - увеличивается по формуле (oldCapacity * 3) / 2 + 1 или простыми словами в 1.5 раза.
