...
2. Примитивы это - short - 	16 бит, byte - 8 бит, char - 16 бит, boolean, int - 32 бит, long - 64 бит, float - 32 бит, double - 64 бит;
...
10.1 Инкопсуляция - сокрытие реализации класса, с доступом к методам;
...
18. Что возвращает compareTo() - 1 = если первое значение больше второго, 0 = если значения равны, -1 = первое значение меньше второго;
